...
public class AIPlayerMinimax extends AIPlayer {
   ...
   public AIPlayerMinimax(String[][] board) {
      super(board);
   }
   ...
   private int[] minimax(int depth, String player) {
      ...
      int bestScore = (player.equals(mySeed)) ? Integer.MIN_VALUE : Integer.MAX_VALUE;
      int currentScore;
      int bestRow = -1;
      int bestCol = -1;
      ...
      if (nextMoves.isEmpty() || depth == 0) {
         ...
         for (int[] move : nextMoves) {
            ...
            if (player.equals(mySeed)) {  // mySeed (computer) is maximizing player
   ...
   private int evaluateLine(int row1, int col1, int row2, int col2, int row3, int col3) {
      ...
      // First cell
      if (cells[row1][col1].equals(mySeed)) {
         score = 1;
      } else if (cells[row1][col1].equals(oppSeed)) {
         score = -1;
      }
 
      // Second cell
      if (cells[row2][col2].equals(mySeed)) {
      ...
      } else if (cells[row2][col2].equals(oppSeed)) {
      ...
      // Third cell
      if (cells[row3][col3].equals(mySeed)) {
      ...
      } else if (cells[row3][col3].equals(oppSeed)) {
